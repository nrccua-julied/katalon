...
WebUI.setText(findTestObject('User Profile/First Name'),   '11')

WebUI.setText(findTestObject('User Profile/Last Name'),   '22')

WebUI.click(findTestObject('User Profile/button_Save'))

WebUI.verifyElementPresent (findTestObject('User Profile/Error_FirstAndLastName'), 1, FailureHandling.OPTIONAL)

WebUI.verifyElementPresent (findTestObject('User Profile/Error_GraduationYear'), 1, FailureHandling.OPTIONAL)

WebUI.click(findTestObject('User Profile/button_Save'))

WebUI.verifyElementPresent (findTestObject('User Profile/Error_InvalidAddress'), 1, FailureHandling.OPTIONAL)

WebUI.verifyElementPresent (findTestObject('User Profile/Error_Invalid State'), 1, FailureHandling.OPTIONAL)

WebUI.verifyElementPresent (findTestObject('User Profile/Error_Invalid City'), 1, FailureHandling.OPTIONAL)

WebUI.verifyElementPresent (findTestObject('User Profile/Error_Invalid Zip Code'), 1, FailureHandling.OPTIONAL)
