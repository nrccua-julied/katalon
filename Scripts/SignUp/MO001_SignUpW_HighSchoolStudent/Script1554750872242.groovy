...
TestingURL = 'https://development2.myoptions.org'
...
String TimeStampEmailAddress = ('nrccua.highschool+' + System.nanoTime()) + '@gmail.com'
...
'Connect to DB'
CustomKeywords.'sql.DevDB.connectDB'('')

'Exec query'
def recordset = CustomKeywords.'sql.DevDB.executeQuery'('select top 1 emailaddress from core.email order by insertdate desc')
WebUI.delay(3)

recordset.next()
println (recordset)
Object name = recordset.getObject("emailaddress")
println (name)
...
WebUI.verifyMatch(TimeStampEmailAddress, name, false)

//WebUI.verifyMatch(TimeStampEmailAddress, record, false)

WebUI.click(findTestObject('Welcome to myOptions/label_High School Student'))

WebUI.delay(3)

WebUI.waitForElementPresent(findTestObject('Welcome to myOptions/div_graduate(d) from'), 1000)

WebUI.setText(findTestObject('Welcome to myOptions/input'), 'Round Rock High School')

WebUI.click(findTestObject('Welcome to myOptions/a_A'))

WebUI.setText(findTestObject('Welcome to myOptions/input_I live at_address_one'), '201 Deepwood Dr.')

WebUI.setText(findTestObject('Welcome to myOptions/input_in_city'), 'Round Rock')

WebUI.focus(findTestObject('Welcome to myOptions/input_in_city'))
...
WebUI.setText(findTestObject('Welcome to myOptions/input_in Zip Code_zip_code'), '78681')

WebUI.click(findTestObject('Welcome to myOptions/div_NoYes'))

WebUI.delay(3)

WebUI.click(findTestObject('Welcome to myOptions/a_Continue'))
